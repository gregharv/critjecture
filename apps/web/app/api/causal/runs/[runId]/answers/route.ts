...
import { createGroundedCausalAnswer, listCausalAnswersForRun } from "@/lib/causal-answers";
...
export async function GET(
  ...
  try {
    const answers = await listCausalAnswersForRun({
    ...
    const message = error instanceof Error ? error.message : "Failed to load causal answers.";
