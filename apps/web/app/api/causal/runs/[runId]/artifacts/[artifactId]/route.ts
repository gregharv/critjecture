...
import { getCausalArtifactDetail } from "@/lib/causal-runs";
...
export async function GET(
  ...
  try {
    const artifact = await getCausalArtifactDetail({
      artifactId,
    ...
    const message = error instanceof Error ? error.message : "Failed to download causal artifact.";
