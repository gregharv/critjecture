...
import { getPredictiveArtifactDetail } from "@/lib/predictive-analysis";
...
export async function GET(
  ...
  try {
    const artifact = await getPredictiveArtifactDetail({
      artifactId,
    ...
    const message = error instanceof Error ? error.message : "Failed to download predictive artifact.";
