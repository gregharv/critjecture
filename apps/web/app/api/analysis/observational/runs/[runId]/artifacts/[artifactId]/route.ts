...
import { getObservationalArtifactDetail } from "@/lib/observational-analysis";
...
export async function GET(
  ...
  try {
    const artifact = await getObservationalArtifactDetail({
      artifactId,
    ...
    const message = error instanceof Error ? error.message : "Failed to download observational artifact.";
