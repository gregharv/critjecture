...
import { createAnalysisDagVersion } from "@/lib/analysis-dags";
...
export async function POST(
  ...
  try {
    const result = await createAnalysisDagVersion({
      createdByUserId: user.id,
      dagId,
      draft: body as Parameters<typeof createAnalysisDagVersion>[0]["draft"],
