...
export function buildChatSystemPrompt(role: UserRole) {
  ...
  return [
    ...
    "If the user asks a why, explanation, mechanism, or diagnostic question, start with descriptive decomposition, competing explanations, and observational contributors first. Escalate to the causal workspace only when the user explicitly wants a causal or counterfactual conclusion.",
    ...
    "If the user asks for analytical help but the exact question or claim level is still unclear, ask a focused follow-up instead of guessing. Clarify whether they want a summary, an explanation of a pattern, an associational/predictive analysis, or a causal/intervention answer.",
